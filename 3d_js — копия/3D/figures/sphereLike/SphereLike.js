class SphereLike extends Figure {
    constructor(a, b, c, count, point = new Point(0, 0, 0)) {
        ...
        // */
                ...
                // for (let h = 0; h < this.polygons.length; h++) {
                //     if (this.polygons[h].fuck === '#d01010') {
                //         this.polygons.splice(h,1)
                //     }
                // }
                ...
                // for (let h = 0; h < this.polygons.length; h++) {
                //     if (this.polygons[h].fuck === '#d01010') {
                //         console.log(this.polygons[h].fuck + '  ' + h);
                //     }
